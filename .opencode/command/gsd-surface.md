...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/good/src/.opencode/.gsd-surface.json`
(sibling to `D:/good/src/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/good/src/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`D:/good/src/.opencode/skills`).
...
`D:/good/src/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/good/src/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/good/src/.opencode/.gsd-surface.json`
Install profile marker: `D:/good/src/.opencode/.gsd-profile`
Skill dirs: `D:/good/src/.opencode/skills/gsd-*/`
Engine module: `D:/good/src/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/good/src/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>

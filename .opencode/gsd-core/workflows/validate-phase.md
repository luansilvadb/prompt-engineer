...
```
Agent(
  prompt="Read D:/good/src/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/good/src/.opencode/gsd-core/templates/VALIDATION.md`

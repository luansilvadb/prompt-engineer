...
ones). Reference: @D:/good/src/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/good/src/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/good/src/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/good/src/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/good/src/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/good/src/.opencode/gsd-core/templates/spec.md.

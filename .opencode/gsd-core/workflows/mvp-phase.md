...
<required_reading>
@D:/good/src/.opencode/gsd-core/references/user-story-template.md
@D:/good/src/.opencode/gsd-core/references/spidr-splitting.md
@D:/good/src/.opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/good/src/.opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/good/src/.opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/good/src/.opencode/gsd-core/references/spidr-splitting.md`. Briefly:

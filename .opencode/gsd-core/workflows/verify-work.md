...
<template>
@D:/good/src/.opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/good/src/.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/good/src/.opencode/gsd-core/workflows/transition.md`.
...
- Follow @D:/good/src/.opencode/gsd-core/workflows/diagnose-issues.md

...
```markdown
Read D:/good/src/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/good/src/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/good/src/.opencode/agents/gsd-ui-checker.md for instructions.

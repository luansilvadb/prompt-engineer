...
<!-- For checkpoint task examples and patterns, see @D:/good/src/.opencode/gsd-core/references/checkpoints.md -->
...
See `D:/good/src/.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/good/src/.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/good/src/.opencode/gsd-core/workflows/verify-phase.md` for verification logic.

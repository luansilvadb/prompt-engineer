...
- Usage: Reference from command with `@D:/good/src/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/good/src/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/good/src/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

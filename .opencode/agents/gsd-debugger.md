...
<required_reading>
@D:/good/src/.opencode/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/good/src/.opencode/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/good/src/.opencode
                  → checks D:/good/src/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/good/src/.opencode/gsd-core
                  → writes to D:/good/src/.opencode/gsd-core/hooks/
...
@D:/good/src/.opencode/gsd-core/references/thinking-models-debug.md
...
- Read @D:/good/src/.opencode/gsd-core/references/common-bug-patterns.md
